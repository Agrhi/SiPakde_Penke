                ...
                <tbody>
                    ...
                    foreach ($penyakit as $value) { ?>
                        <tr>
                            ...
                            <td><?= $value->ketpenyakit ?></td>
                            <td>
                                <button class="btn btn-outline-success btn-sm" data-bs-toggle="modal" onclick="updatepenyakit('<?= $value->kodepenyakit ?>')" data-bs-target="#modaledit">
