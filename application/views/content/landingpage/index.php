...
<head>
  ...
  <title>SiPakde_Penke | Home</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <!-- <a href="index.html" class="logo"><img src="<= base_url() ?>/assets/landing/img/logo.png" alt="" class="img-fluid"></a> -->
      <a href="index.html" class="logo">SiPakde_Penke</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 flex-column justify-content-center">
          <h1>Welcome To<br>SiPakde Penke</h1>
          <h2>SiPakde Penke atau disebut Sistem Pakar Diagnosa Hama & Penyakit Kedelai yaitu sebuah sistem yang dapat digunakan oleh Petani untuk mendiagnosa penyakit tanaman Kedelai yang dia miliki.</h2>
    ...
    <section id="count" class="section-bg">
      <div class="container mt-5">
        ...
        <div class="section-title">
          <h2>Jumlah Data</h2>
          <p>Jumlah Data Pada Website SiPakde Penke</p>
        </div>

        <div class="row counters position-relative">

          <div class="col-lg-3 col-6 text-center">
            <h1 data-purecounter-start="0" data-purecounter-end="232" data-purecounter-duration="1" class="purecounter text-primary"></h1>
            <p>Hama</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <h1 data-purecounter-start="0" data-purecounter-end="521" data-purecounter-duration="1" class="purecounter text-primary"></h1>
            <p>Penyakit</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <h1 data-purecounter-start="0" data-purecounter-end="1463" data-purecounter-duration="1" class="purecounter text-primary"></h1>
            <p>Gejala</p>
          </div>
